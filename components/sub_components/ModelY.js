...
function ModelY() {
  return (
    <div className='  w-[100vw] bg-[url("/Model-Y.avif")] bg-no-repeat bg-center bg-cover flex flex-col justify-between items-center carousel-item '>
    <div className='flex flex-col items-center mt-32 '>
        <h1 className=' font-semibold text-4xl'>Model Y</h1>
        <div className='flex flex-col justify-center items-center mt-3'>
        <h2  className=''>Starting at $40,240</h2>
