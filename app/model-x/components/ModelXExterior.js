  ...
  return (
    <div>
      <div className="flex flex-col xl:flex-row">
        ...
        >
          <ul className="  flex justify-between items-end text-white  h-96 md:h-[70vh] xl:h-screen pb-6 ">
      ...
      <div className="relative  h-80 md:h-screen w-full ">
        <Image src={`/Model-X/Model-X-Exterior-Hero-Desktop-Global.avif`} alt='Image not found' fill className="" />
      </div>
